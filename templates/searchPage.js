function displaySearchPage(inputGenre, inputAlbums, inputArtists, inputSingles) {
    content = `
    <div class="main-left">
    ...
    assignArtistRowSearchPage(inputArtists);
    assignAlbumRowSearchPage(inputAlbums);
    assignSingleRowSearchPage(inputSingles);
...
function assignArtistRowSearchPage(inputArtists) {
    ...
    if (inputArtists.length === 0){
        ...
        content = `
            <div id="genre-page-artist-row-0" class="genre-page-artist-list-row d-flex"></div>
        `;
    }
    document.getElementById("genre-page-artist-box").innerHTML = content;
}

function assignAlbumRowSearchPage(inputAlbums) {
    content = ``;
...
function assignSingleRowSearchPage(inputSingles) {
    content = ``;
    if (inputSingles.length === 0) {
        content += `
        <div id="genre-page-single-row-0" class="genre-page-single-list-row d-flex" style="height:0px;"></div>
        `;
    } else if (inputSingles.length > 6) {
        ...
        content += `
        <div id="genre-page-single-row-0" class="genre-page-single-list-row d-flex"></div>
        `;
    }
...
function assignSearchPageSingleCard(inputSingles) {
    if (inputSingles.length !== 0) {
...
function assignSearchPageAlbumCard(inputAlbums) {
    if (inputAlbums.length !== 0) {
